    ...
    <div className="flex h-screen bg-[#f3f6f4] text-[#233337]">
      ...
      <div className="flex-1 p-6 overflow-auto">
        ...
        <div className="mb-4 flex gap-3">
          <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Search..." className="flex-1 rounded border border-[#cfdcd8] bg-white px-3 py-2 text-[#18292c] outline-none focus:border-teal-600" />
        ...
        {listLoading && <p className="mb-3 text-sm text-[#5a7275]">Loading problems...</p>}
